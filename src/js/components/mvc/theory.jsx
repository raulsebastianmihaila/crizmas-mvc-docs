...
export default () => <div>
  ...
  <p>This mechanism is based on an observation instrument: <Ticks text="observe()" />.
  ...
  a class or a plain old constructor function. (<Ticks text="controller()" /> is like <Ticks
  text="observe()" /> but it doesn't accept promises or thenables.)</p>
  ...
  If a function is observed independently, <Ticks text="observe()" /> can
  ...
  <p><Ticks text="observe()" /> can also receive a <Ticks text="preventApply" /> option.
  If the argument to <Ticks text="observe()" /> is a function and this option is passed,
  ...
  text="controller()" /> and <Ticks text="root()" /> (see below).</p>
  ...
  object marked as root using <Ticks text="root()" />.
  ...
  of objects, we need a mechanism for this: <Ticks text="unroot()" />.
  ...
  of the notification process. Therefore we provide the <Ticks text="ignore()" /> mechanism
  ...
  in the view. We assume that the controller is defined using <Ticks text="controller()" />,
  ...
  using <Ticks text="apply" /> with the controller and a custom key). Or, simply,
