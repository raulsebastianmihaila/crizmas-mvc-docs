...
export default () => <div>
  ...
  <p>The code is written in modern JS, so it's possible that you need
  transcompilation. JSX is not used in the framework code so you're not obliged to support JSX.</p>
