export default [
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        link: 'addObservedChild',
        label: 'addObservedChild()'
      },
      {
        link: 'removeObservedChild',
        label: 'removeObservedChild()'
      },
      {
        link: 'PromiseQueue',
        label: 'new PromiseQueue()'
      },
      {
        link: 'promiseQueue.add',
        label: 'promiseQueue.add()'
      },
      {
        link: 'Cancellation',
      ...
      {
        link: 'cancellation.signal',
        label: 'cancellation.signal'
      },
      {
        link: 'cancellation.cancellable',
        label: 'cancellation.cancellable()'
      },
      {
        link: 'cancellation.cancel',
        label: 'cancellation.cancel()'
      }
    ]
  },
  {
